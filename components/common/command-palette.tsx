...
const QUICK_ACTIONS = [
  ...
  },
  {
    ...
    subtitle: "Configure OCR confidence thresholds and legal rulesets",
    category: "Actions" as const,
    icon: <Settings className="size-4 text-[#1D4ED8]" />,
    href: "/settings",
  },
  {
    id: "act-profile",
    title: "Inspector Profile & Clearances",
    subtitle: "Active enforcement jurisdiction and officer credentials",
    category: "Actions" as const,
