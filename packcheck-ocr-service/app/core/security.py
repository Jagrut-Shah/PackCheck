...
async def verify_api_key(api_key: str = Security(api_key_header)) -> str:
    ...
    """
    expected_key = (settings.OCR_SERVICE_API_KEY or "a3e7d5678af45055bcdb276fe1c304fff35375ee359373c67aed2234d6487057").strip().strip("\"'")
    if not expected_key:
        raise HTTPException(
    ...
    if not clean_api_key or not secrets.compare_digest(clean_api_key, expected_key):
        raise HTTPException(
